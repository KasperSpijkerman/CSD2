...
//    // setting parameters for the LCRDelay
//    for (LcrDelay& LcrDelay : LcrDelays)
//    {
//
//    }
    LcrDelay.setDelayLine(0,previousdelayTimeL.getNextValue(),previousfeedbackL.getNextValue(),previousdryWetL.getNextValue());
    LcrDelay.setDelayLine(1,previousdelayTimeR.getNextValue(),previousfeedbackR.getNextValue(),previousdryWetR.getNextValue());
    LcrDelay.setDelayLine(2,previousdelayTimeC.getNextValue(),previousfeedbackC.getNextValue(),previousdryWetC.getNextValue());
