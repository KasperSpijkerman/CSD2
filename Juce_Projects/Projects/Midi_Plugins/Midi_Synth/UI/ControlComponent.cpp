...
void ControlComponent::paint(juce::Graphics& g) {
    ...
    LightTextButton.setColour(TextButton::textColourOffId, juce::Colours::black);

    buttonStyle.drawButtonBackground(g, DarkTextButton, juce::Colours::black, DarkTextButton.buttonNormal,
                                     DarkTextButton.buttonDown);
    DarkTextButton.setColour(TextButton::textColourOffId, juce::Colours::lightgrey);

    // 2nd set
    buttonStyle.drawButtonBackground(g, condensedTextButton, juce::Colours::green, condensedTextButton.buttonNormal,
                                     condensedTextButton.buttonDown);
    condensedTextButton.setColour(TextButton::textColourOffId, juce::Colours::white);

    buttonStyle.drawButtonBackground(g, spaciousTextButton, juce::Colours::deeppink, spaciousTextButton.buttonNormal,
                                     spaciousTextButton.buttonDown);
    spaciousTextButton.setColour(TextButton::textColourOffId, juce::Colours::greenyellow);

    // 3rd set
    buttonStyle.drawButtonBackground(g, predictableTextButton, juce::Colours::lightgreen,
                                     predictableTextButton.buttonNormal, predictableTextButton.buttonDown);
    predictableTextButton.setColour(TextButton::textColourOffId, juce::Colours::lightsalmon);

    buttonStyle.drawButtonBackground(g, experimentalTextButton, juce::Colours::orange,
                                     experimentalTextButton.buttonNormal, experimentalTextButton.buttonDown);
    experimentalTextButton.setColour(TextButton::textColourOffId, juce::Colours::greenyellow);

    // 4th set
    buttonStyle.drawButtonBackground(g, fastTextButton, juce::Colours::orange, fastTextButton.buttonNormal,
                                     fastTextButton.buttonDown);
    fastTextButton.setColour(TextButton::textColourOffId, juce::Colours::yellow);

    buttonStyle.drawButtonBackground(g, slowTextButton, juce::Colours::purple, slowTextButton.buttonNormal,
                                     slowTextButton.buttonDown);
    slowTextButton.setColour(TextButton::textColourOffId, juce::Colours::black);

    // 5th set
    buttonStyle.drawButtonBackground(g, roughTextButton, juce::Colours::darkblue, roughTextButton.buttonNormal,
                                     roughTextButton.buttonDown);
    roughTextButton.setColour(TextButton::textColourOffId, juce::Colours::yellow);

    buttonStyle.drawButtonBackground(g, smoothTextButton, juce::Colours::orange, smoothTextButton.buttonNormal,
                                     smoothTextButton.buttonDown);
    smoothTextButton.setColour(TextButton::textColourOffId, juce::Colours::lightcyan);

    // 6th set
    buttonStyle.drawButtonBackground(g, shortTextButton, juce::Colours::purple, shortTextButton.buttonNormal,
                                     shortTextButton.buttonDown);
    shortTextButton.setColour(TextButton::textColourOffId, juce::Colours::lightsalmon);

    buttonStyle.drawButtonBackground(g, longTextButton, juce::Colours::darkblue, longTextButton.buttonNormal,
                                     longTextButton.buttonDown);
    longTextButton.setColour(TextButton::textColourOffId, juce::Colours::white);
}
...
void ControlComponent::resized()
{
    ...
    roughTextButton.setBounds(0, buttonPosY + offsetY, buttonWidth, buttonHeigth);
    smoothTextButton.setBounds(roughTextButton.getRight(), buttonPosY + offsetY, buttonWidth, buttonHeigth);
    condensedTextButton.setBounds(0, buttonPosY + offsetY*2, buttonWidth, buttonHeigth);
    spaciousTextButton.setBounds(condensedTextButton.getRight(), buttonPosY + offsetY*2, buttonWidth, buttonHeigth);
    experimentalTextButton.setBounds(0, buttonPosY + offsetY*3, buttonWidth, buttonHeigth);
    predictableTextButton.setBounds(experimentalTextButton.getRight(), buttonPosY + offsetY*3 , buttonWidth, buttonHeigth);
    fastTextButton.setBounds(0, buttonPosY + offsetY*4, buttonWidth, buttonHeigth);
    slowTextButton.setBounds(fastTextButton.getRight(), buttonPosY + offsetY*4, buttonWidth, buttonHeigth);
    longTextButton.setBounds(0, buttonPosY + 300, buttonWidth, buttonHeigth);
    shortTextButton.setBounds(longTextButton.getRight(), buttonPosY + 300, buttonWidth, buttonHeigth);
