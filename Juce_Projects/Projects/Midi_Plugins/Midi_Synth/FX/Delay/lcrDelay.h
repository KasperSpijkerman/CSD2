...
public:
    ...
    void lcrIncrementC();
    //setters and getters
    void changeDelayLine(const int ch, const float delaytime, const float feedback,const float drywet,const float bpm,const float division, const bool sync);
protected:
