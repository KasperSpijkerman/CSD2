...
//==============================================================================
TestLCRAudioProcessorEditor::TestLCRAudioProcessorEditor (TestLCRAudioProcessor& p,juce::AudioProcessorValueTreeState& vts)
...
TestLCRAudioProcessorEditor::~TestLCRAudioProcessorEditor()
{}

//==============================================================================
void TestLCRAudioProcessorEditor::paint (juce::Graphics& g)
{
    // (Our component is opaque, so we must completely fill the background with a solid colour)
    g.fillAll (juce::Colours::darkviolet);
    g.setFont (juce::Font ("New Times Roman", 83.0f, juce::Font::bold));
    g.setColour(juce::Colours::orange);
    g.drawText("TestLCR",160,50,500,100,juce::Justification::centred);
...
void TestLCRAudioProcessorEditor::resized()
{
    // layout sliders
...
void TestLCRAudioProcessorEditor::oscMessageReceived (const juce::OSCMessage& message)
{
...
void TestLCRAudioProcessorEditor::showConnectionErrorMessage (const juce::String& messageText)
{
