...
//==============================================================================
TestLCRAudioProcessor::TestLCRAudioProcessor()
:
...
//==============================================================================
const juce::String TestLCRAudioProcessor::getName() const
{
    return JucePlugin_Name;
}

bool TestLCRAudioProcessor::acceptsMidi() const
{
...
bool TestLCRAudioProcessor::producesMidi() const
{
...
bool TestLCRAudioProcessor::isMidiEffect() const
{
...
double TestLCRAudioProcessor::getTailLengthSeconds() const
{
    return 0.0;
}

int TestLCRAudioProcessor::getNumPrograms()
{
    return 1;   // NB: some hosts don't cope very well if you tell them there are 0 programs,
                // so this should be at least 1, even if you're not really implementing programs.
}

int TestLCRAudioProcessor::getCurrentProgram()
{
    return 0;
}

void TestLCRAudioProcessor::setCurrentProgram (int index)
{
}

const juce::String TestLCRAudioProcessor::getProgramName (int index)
{
    return {};
}

void TestLCRAudioProcessor::changeProgramName (int index, const juce::String& newName)
{
}

//==============================================================================
void TestLCRAudioProcessor::prepareToPlay (double sampleRate, int samplesPerBlock)
{
//    for (TestLCR& TestLCR : TestLCRs)
//    {
//
//    }
...
void TestLCRAudioProcessor::releaseResources()
{
...
bool TestLCRAudioProcessor::isBusesLayoutSupported (const BusesLayout& layouts) const
{
  #if JucePlugin_IsMidiEffect
...
void TestLCRAudioProcessor::processBlock (juce::AudioBuffer<float>& buffer, juce::MidiBuffer& midiMessages)
{
...
//==============================================================================
bool TestLCRAudioProcessor::hasEditor() const
{
    return true; // (change this to false if you choose to not supply an editor)
}

juce::AudioProcessorEditor* TestLCRAudioProcessor::createEditor()
{
    return new TestLCRAudioProcessorEditor (*this,apvts);
}

//==============================================================================
void TestLCRAudioProcessor::getStateInformation (juce::MemoryBlock& destData)
{
...
void TestLCRAudioProcessor::setStateInformation (const void* data, int sizeInBytes)
{
...
{
    return new TestLCRAudioProcessor();
}

juce::AudioProcessorValueTreeState::ParameterLayout TestLCRAudioProcessor::createParameters()
{
