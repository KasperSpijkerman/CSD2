...
class TestLCRAudioProcessorEditor  : public juce::AudioProcessorEditor,
                                              public TestLCRAudioProcessor,
                                              private juce::OSCReceiver, // [1]
                                              private juce::OSCReceiver::ListenerWithOSCAddress<juce::OSCReceiver::MessageLoopCallback> // [2]
{

public:
    TestLCRAudioProcessorEditor (TestLCRAudioProcessor&,juce::AudioProcessorValueTreeState&);
    ~TestLCRAudioProcessorEditor() override;
...
private:
    ...
    TestLCRAudioProcessor& audioProcessor;
    JUCE_DECLARE_NON_COPYABLE_WITH_LEAK_DETECTOR (TestLCRAudioProcessorEditor)
};
